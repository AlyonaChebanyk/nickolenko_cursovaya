# Deep Convolutional GAN with Keras GANs Components -> Generator G  Converts noise z to fake images G(z) similar to
# real images x Discriminator D -> Tries to distinguish between real (x) and fake images generated(G(z)) Learning
# Mechanism -> Both the Generator and Discriminator learns by playing a zero sum min-max game. Solution is the Saddle
# point solution of the classification logloss of Real and Fake images. The saddle point would be a minima point with
# respect to the Discriminator and maxima with respect to the Generator This saddle point in terms of Game theory is
# the famous Nash Equilibrium. At the Nash equilibrium the probability distribution of the Generator Images should
# match the probability distribution of the Real Images i.e. P(G(z)) ~  P(x)
...
# python captcha_gan.py train
# --dest_train '/home/santanu/Downloads/train_32x32.mat'
# --outdir '/home/santanu/ML_DS_Catalog-/captcha/SVHN/'
# --dir_flag False
# --batch_size 100
# --gen_input_dim 100
# --gen_beta1 0.5
# --gen_lr 0.0001
# --dis_input_dim '(32,32,3)'
# --dis_lr 0.001
# --dis_beta1 0.5
# --alpha 0.2
# --epochs 100
...
if __name__ == '__main__':
    with ElapsedTimer('main'):
        fire.Fire(train(dest_train='train_32x32.mat',
                        outdir='SVHN/',
                        dir_flag=False,
                        batch_size=100,
                        gen_input_dim=100,
