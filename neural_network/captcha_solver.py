...
from keras.layers import Dropout, Activation, Convolution2D, GlobalAveragePooling2D, merge, MaxPooling2D, Conv2D, \
    Flatten, Dense, Input
...
# --dest_train '/home/santanu/Downloads/Captcha Generation/captcha_train/'
# --dest_val '/home/santanu/Downloads/Captcha Generation/captcha_val/'
# --outdir '/home/santanu/ML_DS_Catalog-/captcha/model/'
# --batch_size 16
# --lr 1e-3
# --epochs 20
# --n_classes 36
...
# python captcha_solver.py evaluate
# --model_path /home/santanu/ML_DS_Catalog-/captcha/model/captcha_breaker.h5
# --eval_dest '/home/santanu/Downloads/Captcha Generation/captcha_test/'
# --outdir /home/santanu/ML_DS_Catalog-/captcha/
# --fetch_target True


if __name__ == '__main__':
    with ElapsedTimer('captcha_solver'):
        # fire.Fire(train(dest_train='captcha_train/',
        #                 dest_val='captcha_val/',
        #                 outdir='model/',
        #                 batch_size=16,
        #                 lr=1e-3,
        #                 epochs=20,
        ...
        #                 shuffle=True,
        #                 dim=(40, 100, 1)))
        fire.Fire(evaluate(model_path='model/captcha_breaker.h5',
                           eval_dest='captcha_test/',
                           outdir='captcha/',
                           fetch_target=True))
